...
saveRDS(y.count, "~/GitHub/caplter-dynamicbirds/data/input/bird_observations_countbysurvey.rds")
saveRDS(K, "~/GitHub/caplter-dynamicbirds/data/input/bird_observations_surveycount.rds")
...
write.csv(obs.seas, "~/GitHub/caplter-dynamicbirds/data/input/bird_observations_countmeanbyseason.csv", row.names = FALSE)
# write.csv(obs.all, "~/GitHub/caplter-dynamicbirds/data/input/bird_observations_cleaned.csv", row.names = FALSE)
