...
write.csv(bird.list.joined, "~/GitHub/caplter-dynamicbirds/data/listofspecies_corebirds.csv", row.names = FALSE)
```
...
write.csv((bird.list.joined %>% filter(code %in% unique(obs$code))), "~/GitHub/caplter-dynamicbirds/data/listofspecies_corebirds_nearbyonly.csv", row.names = FALSE)
```
...
# write.csv(obs.seas, "~/GitHub/caplter-dynamicbirds/data/spp/bird_observations_countmeanbyseason.csv", row.names = FALSE)
