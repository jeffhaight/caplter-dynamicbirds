---
title: "CAP LTER Birds 2025 - Autologistic Community Occupancy Model"
...
list.files("G:/Shared drives/CAP USE Postdoc/projects/DynamicBirds/data/input")

# This contains data assembled by the '2_1_StatisticalModelingSetup_CAPbirds' file
load("G:/Shared drives/CAP USE Postdoc/projects/DynamicBirds/data/input/modelinputs_CAPbirds2024.RData")
...
out <- jags(bdata, inits, parameters.to.save = c(
  ...
  "G:/Shared drives/CAP USE Postdoc/projects/DynamicBirds/code/communityoccupancy_autologistic.R",
...
# n = 30 samples
  # write.csv(msum, "G:/Shared drives/CAP USE Postdoc/projects/DynamicBirds/data/output/MSOM_CAPbirds_spring_summary30.csv")

# n = 80 samples
  # saveRDS(out$sims.list, "G:/Shared drives/CAP USE Postdoc/projects/DynamicBirds/data/output/MSOM_CAPbirds_spring_80samp.rds")
  # write.csv(msum, "G:/Shared drives/CAP USE Postdoc/projects/DynamicBirds/data/output_summary/MSOM_CAPbirds_spring_summary80samp.csv")

# n = 600 samples
  # saveRDS(out$sims.list, "G:/Shared drives/CAP USE Postdoc/projects/DynamicBirds/data/output/MSOM_CAPbirds_spring_600samp.rds")
  # write.csv(msum, "G:/Shared drives/CAP USE Postdoc/projects/DynamicBirds/data/output_summary/MSOM_CAPbirds_spring_summary600samp.csv")

# n = 800 samples
  # saveRDS(out$sims.list, "G:/Shared drives/CAP USE Postdoc/projects/DynamicBirds/data/output/MSOM_CAPbirds_spring_800samp.rds")
  # write.csv(msum, "G:/Shared drives/CAP USE Postdoc/projects/DynamicBirds/data/output_summary/MSOM_CAPbirds_spring_summary800samp.csv")

# n = 1600 samples
  # saveRDS(out$sims.list, "G:/Shared drives/CAP USE Postdoc/projects/DynamicBirds/data/output/MSOM_CAPbirds_spring_1600samp.rds")
  # write.csv(msum, "G:/Shared drives/CAP USE Postdoc/projects/DynamicBirds/data/output_summary/MSOM_CAPbirds_spring_summary1600samp.csv")

# n = 2400 samples
 # saveRDS(out$sims.list, "G:/Shared drives/CAP USE Postdoc/projects/DynamicBirds/data/output/MSOM_CAPbirds_spring_2400samp.rds")
 #  write.csv(msum, "G:/Shared drives/CAP USE Postdoc/projects/DynamicBirds/data/output_summary/MSOM_CAPbirds_spring_summary2400samp.csv")


# n = 6000 samples
# saveRDS(out$sims.list, "G:/Shared drives/CAP USE Postdoc/projects/DynamicBirds/data/output/MSOM_CAPbirds_spring_6000samp.rds")
# write.csv(msum, "G:/Shared drives/CAP USE Postdoc/projects/DynamicBirds/data/output_summary/MSOM_CAPbirds_spring_summary6000samp.csv")
  
  
# n = 8000 samples
  # saveRDS(out$sims.list, "G:/Shared drives/CAP USE Postdoc/projects/DynamicBirds/data/output/MSOM_CAPbirds_spring_8000samp.rds")
  # write.csv(msum, "G:/Shared drives/CAP USE Postdoc/projects/DynamicBirds/data/output_summary/MSOM_CAPbirds_spring_summary8000samp.csv")


# n = 12000 samples
 # saveRDS(out$sims.list, "G:/Shared drives/CAP USE Postdoc/projects/DynamicBirds/data/output/MSOM_CAPbirds_spring_12ksamp.rds")
 #  write.csv(msum, "G:/Shared drives/CAP USE Postdoc/projects/DynamicBirds/data/output_summary/MSOM_CAPbirds_spring_summary12ksamp.csv")

# n = 16000 samples  
  #  saveRDS(out$sims.list, "G:/Shared drives/CAP USE Postdoc/projects/DynamicBirds/data/output/MSOM_CAPbirds_spring_16ksamp.rds")
  # write.csv(msum, "G:/Shared drives/CAP USE Postdoc/projects/DynamicBirds/data/output_summary/MSOM_CAPbirds_spring_summary16ksamp.csv")
  
# n = 24000 samples  
  #  saveRDS(out$sims.list, "G:/Shared drives/CAP USE Postdoc/projects/DynamicBirds/data/output/MSOM_CAPbirds_spring_24ksamp.rds")
  # write.csv(msum, "G:/Shared drives/CAP USE Postdoc/projects/DynamicBirds/data/output_summary/MSOM_CAPbirds_spring_summary24ksamp.csv")
   
# n = 30000 samples  
  #  saveRDS(out$sims.list, "G:/Shared drives/CAP USE Postdoc/projects/DynamicBirds/data/output/MSOM_CAPbirds_spring_30ksamp.rds")
  # write.csv(msum, "G:/Shared drives/CAP USE Postdoc/projects/DynamicBirds/data/output_summary/MSOM_CAPbirds_spring_summary30ksamp.csv")
    
# n = 40000 samples  
   saveRDS(out$sims.list, "G:/Shared drives/CAP USE Postdoc/projects/DynamicBirds/data/output/MSOM_CAPbirds_spring_40ksamp.rds")
  write.csv(msum, "G:/Shared drives/CAP USE Postdoc/projects/DynamicBirds/data/output_summary/MSOM_CAPbirds_spring_summary40ksamp.csv")


# test model controlling for phylogenetic effects
  # saveRDS(out$sims.list, "G:/Shared drives/CAP USE Postdoc/projects/DynamicBirds/data/output/MSOM_CAPbirds_spring_phyl_8000samp.rds")
  # write.csv(msum, "G:/Shared drives/CAP USE Postdoc/projects/DynamicBirds/data/output_summary/MSOM_CAPbirds_spring_phyl_summary8000samp.csv")
```
